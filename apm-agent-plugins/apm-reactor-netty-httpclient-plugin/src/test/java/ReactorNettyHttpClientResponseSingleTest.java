 ...
 */
public class ReactorNettyHttpClientResponseSingleTest extends AbstractHttpClientInstrumentationTest {
    ...
    protected void performGet(String path) throws Exception {
        client
            ...
            .get()
            .uri(path)
            .responseSingle((response, byteBufMono) -> byteBufMono.map(unused -> response))
            .block();
    }
